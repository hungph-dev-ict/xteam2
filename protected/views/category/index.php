...
<!--                                <div class="amount-range-price">Range: $50 - $350</div>-->
                                <ul class="check-box-list">
                                    <li>
                                        ...
                                        < 100000 VND<span class="count"></span>
                                        </label>   
                                    </li>
                                    <li>
                                        ...
                                        <label for="p2">
                                        <span class="button"></span>
                                        100000 - 900000 VND<span class="count"></span>
                                        </label>   
                                    </li>
                                    <li>
                                        ...
                                        <label for="p3">
                                        <span class="button"></span>
                                        > 900000 VND<span class="count"></span>
                                        </label>   
                                    </li>
                                </ul>
                            </div>
                         ...
                         foreach($productSpecial as $item){ ?>
                            ...
                            <li>
                                ...
                                <div class="products-block-right">
                                    ...
                                    <p class="product-price"><?php echo $item['price_new'] ?> VND</p>
...
//                                        ?>
                        ...
                        <div class="products-block">
                            <div class="products-block-bottom">
                             <button class="link-all" onclick="getSpecial('special')">Tất cả</button>
                            </div>
                        </div>
                    </div>
                </div>
