                    ...
                    <tbody>
                        ...
                        <tr>
                                    ...
                                    <td class="cart_description">
                                        ...
                                        <small><p>ID Color : <?php echo $info->id_color ?></p></small>
                                        <small><p>ID Size : <?php echo $info->id_size ?></p></small>
                                    </td>
                                    <?php
                                    if($info->quanty>0){?>
                                   ...
                                   <?php }
                                    ...
                                    <td class="price"><span><?php echo $info->price_new ?> VND</span></td>
                                    <td class="qty" id="qty">
...
<!--                                        <input name="url" type="hidden" id="url<?php echo $info->id_product?>" value="<?php echo Yii::app()->request->url ?>">-->
                                    ...
                                    <td class="price">
                                        <span><?php echo $info->price_new * $value?> VND</span>
                                    </td>
                                    <td class="action">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="3"><?php echo $total?> VND</td>
                        </tr>
                        <tr>
