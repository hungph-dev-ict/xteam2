                                            ...
                                            <li>
                                                  <div class="left-block">
                                                    <a href="<?php echo Yii::app()->request->baseUrl.'/Detail/Detail/id/'; ?><?php  echo $pro['id_product']?>"><img class="img-responsive" alt="product" src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $pro['image'] ?>" /></a>
                                                      <?php if($pro['is_sale']) {?>
                                                          <div class="price-percent-reduction2">-<?php echo $pro['is_sale_percent'] ?>% OFF</div>
                                                      <?php } ?>
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="content_price">
                                                        <span class="price product-price"><?php echo $pro['price_new'] ?> VND</span>
                                                        <?php if($pro['is_sale']) {?>
                                                            <span class="price old-price"><?php echo $pro['price_old'] ?> VND</span>
                                                        <?php } ?>
                                                    </div>
                                        ...
                                        foreach ($proItem['most_pro'] as $pro_most) {//lay san pham xem nhieu
                                            ...
                                            <li>
                                                <div class="left-block">
                                                    ...
                                                    <?php if($pro_most['is_sale']) {?>
                                                        <div class="price-percent-reduction2">-<?php echo $pro_most['is_sale_percent'] ?>% OFF</div>
                                                    <?php } ?>
                                                    <div class="quick-view">
                                                        <a title="Add to my wishlist" class="heart" href="#"></a>
                                                        <a title="Add to compare" class="compare" href="#"></a>
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="content_price">
                                                        <span class="price product-price"><?php echo $pro_most['price_new'] ?> VND</span>
                                                        <?php if($pro_most['is_sale']) {?>
                                                            <span class="price old-price"><?php echo $pro_most['price_old'] ?> VND</span>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="product-star">
                                                        <i class="fa fa-star"></i>
