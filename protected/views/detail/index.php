    ...
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            <a class="home" href="<?php echo Yii::app()->request->baseUrl;?>/" title="Return to Home">Home</a>
                            ...
                            <ul class="products-block best-sell">
                                ...
                                foreach($betterLeft as $item){?>
                                    ...
                                    <div class="products-block-right">
                                        ...
                                        <p id="pri_<?php echo $item['id_product'] ?>" class="product-price"><?php echo $item['price_new'] ?> VND</p>
                                ...
                                <div class="product-container">
                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="content_price">
                                            <span id="pri_<?php echo $item['id_product'] ?>" class="price product-price"><?php echo $item['price_new'] ?> VND</span>
                                            <span class="price old-price"><?php echo $item['price_old'] ?> VND</span>
                                        </div>
                                    </div>
...
<!--                                            </li>-->
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-price-group">
                                    <span id="pri_<?php echo $item['id_product'] ?>" class="price"><?php echo $item['price_new'] ?> VND</span>
                                    <?php if($item['is_sale']) {?>
                                        <span class="old-price"><?php echo $item['price_old'] ?> VND</span>
